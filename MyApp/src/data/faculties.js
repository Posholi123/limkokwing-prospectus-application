    ...
    courses: [
      {
        ...
        description: "Learn creative advertising strategies and visual communication.",
        image: require('../../assets/images/advertising.jpg'),
        videoUrl: require('../../assets/videos/creative-advertising.mp4')
      },
      {
        id: 2,
        name: "Diploma in Graphic Design",
        description: "Master digital and print design principles.",
        image: require('../../assets/images/graphic.jpg'),
        videoUrl: require('../../assets/videos/graphic-design.mp4')
      },
      {
        id: 3,
      ...
      },
      {
        ...
        description: "Learn spatial planning and interior aesthetics.",
        image: require('../../assets/images/interior.jpg'),
        videoUrl: require('../../assets/videos/interior-design.mp4')
      },
      {
        id: 5,
    ...
    courses: [
      {
        ...
        description: "Master professional communication strategies.",
        image: require('../../assets/images/communication.jpg'),
        videoUrl: require('../../assets/videos/professional-communication.mp4')
      },
      {
        id: 2,
  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        image: require('../../assets/images/bus-mgt.jpg'),
        videoUrl: require('../../assets/videos/business-management.mp4')
      },
      {
        id: 5,
  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        description: "Comprehensive IT and computing studies.",
        image: require('../../assets/images/it.jpg'),
        videoUrl: require('../../assets/videos/information-technology.mp4')
      },
      {
        id: 4,
